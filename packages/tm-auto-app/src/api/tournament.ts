import * as TMWeb from "@/api/tm-web";
import { EventEmitter } from "events";
import { Fieldset } from "@/api/fieldset";

export class Tournament extends EventEmitter {
  public tmWeb = new TMWeb.TMWeb();
  public eBus = new EventEmitter();
  public fieldsets = new Map<number, Fieldset>();
  async connect(tmWeb: TMWeb.Connect): Promise<void> {
    this.emit("connect");
